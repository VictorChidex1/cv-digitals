  ...
  return (
    <footer className="bg-slate-950/95 relative z-20 w-full overflow-hidden border-none text-slate-400">
      ...
      <div className="container mx-auto px-4 pt-20 pb-12 md:pt-32 md:pb-16 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center justify-between gap-16 md:flex-row md:items-start md:gap-0">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-6 md:w-auto md:items-end">
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm font-medium tracking-wide text-slate-300 md:gap-10">
        ...
        <div className="mt-20 md:mt-28 flex flex-col items-center justify-between gap-6 text-xs text-slate-500 md:flex-row border-t border-slate-900 pt-8">
          <p>&copy; {new Date().getFullYear()} CV Digitals. All rights reserved.</p>
          <div className="flex space-x-6 font-medium">
            <a href="#" className="transition-colors duration-300 hover:text-slate-300">Privacy Policy</a>
            <a href="#" className="transition-colors duration-300 hover:text-slate-300">Terms of Service</a>
          </div>
        </div>
