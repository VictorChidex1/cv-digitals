...
export function ContactTerminal() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      setErrorMsg(
        "Transmission failed. Secure channel compromised or Firebase DB offline."
      );
    } finally {
      ...
      <section className="relative w-full bg-slate-950 py-24 z-20 border-t border-white/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="w-full bg-slate-900 border border-emerald-500/50 rounded-[2rem] p-8 md:p-16 text-center flex flex-col items-center justify-center min-h-[50vh] shadow-[0_0_100px_rgba(16,185,129,0.1)]">
            ...
            <p className="text-slate-400 font-mono text-base md:text-lg max-w-lg leading-relaxed">
              Your operational parameters have been logged into our secure
              ledger. Stand by for architectural contact within 24 hours.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="col-span-1 lg:col-span-4 flex flex-col gap-12">
            <div className="space-y-8">
              ...
              <div className="flex flex-col gap-6">
                <a
                  href="mailto:cvdigitalsltd@gmail.com"
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs font-bold font-mono uppercase text-slate-500 tracking-widest">
                      Secure Email
                    </span>
                    <span className="text-white font-medium group-hover:text-blue-400 transition-colors">
                      cvdigitalsltd@gmail.com
                    </span>
                  </div>
                </a>
            ...
            <div className="p-6 md:p-8 rounded-[2rem] bg-slate-900 border border-white/5 shadow-xl relative overflow-hidden">
              ...
              <p className="text-slate-400 text-sm font-light leading-relaxed">
                Due to intensive computational and creative requirements, CV
                Digitals operates on a strict queue. High-budget enterprise
                infrastructure and elite audio networking deployments are
                prioritized.
              </p>
            </div>
          </div>
            ...
            >
              {errorMsg && (
                <div className="w-full bg-red-500/10 border border-red-500/30 rounded-xl p-4 flex items-center gap-3">
                  ...
                  <p className="text-red-400 font-mono text-sm uppercase font-bold">
                    {errorMsg}
                  </p>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
                ...
                <div className="space-y-2 relative">
                  <label className="text-xs uppercase tracking-widest font-mono font-bold text-slate-300 block">
                    Operational Designation (Name)
                  </label>
                  <input
                    {...register("name")}
                    type="text"
                  ...
                  />
                  {errors.name && (
                    <span className="text-red-400 text-xs font-mono absolute -bottom-6 left-0">
                      {errors.name.message}
                    </span>
                  )}
                </div>
              ...
              <div className="space-y-3 pt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <button
                    type="button"
                    onClick={() =>
                      setValue("scope", "software", { shouldValidate: true })
                    }
                    className={`p-4 rounded-xl border flex items-center justify-between transition-all ${
                      watchScope === "software"
                        ? "bg-blue-500/10 border-blue-500 text-white shadow-[0_0_20px_rgba(59,130,246,0.2)]"
                        : "bg-slate-950/80 border-white/20 text-slate-300 hover:border-white/40 hover:bg-slate-900"
                    }`}
                  >
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setValue("scope", "audio", { shouldValidate: true })
                    }
                    className={`p-4 rounded-xl border flex items-center justify-between transition-all ${
                      watchScope === "audio"
              ...
              <div className="space-y-3 pt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <button
                    type="button"
                    onClick={() =>
                      setValue("budget", "startup", { shouldValidate: true })
                    }
                    className={`p-4 rounded-xl border font-mono text-base transition-all text-center ${
                      watchBudget === "startup"
                        ? "bg-white/10 border-white text-white font-bold shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                        : "bg-slate-950/80 border-white/20 text-slate-300 hover:border-white/40 hover:bg-slate-900"
                    }`}
                  >
                    &lt; $5k
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setValue("budget", "enterprise", { shouldValidate: true })
                    }
                    className={`p-4 rounded-xl border font-mono text-base transition-all text-center ${
                      watchBudget === "enterprise"
                        ? "bg-white/10 border-white text-white font-bold shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                        : "bg-slate-950/80 border-white/20 text-slate-300 hover:border-white/40 hover:bg-slate-900"
                    }`}
                  >
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setValue("budget", "global", { shouldValidate: true })
                    }
                    className={`p-4 rounded-xl border font-mono text-base transition-all text-center ${
                      watchBudget === "global"
                        ? "bg-white/10 border-white text-white font-bold shadow-[0_0_20px_rgba(255,255,255,0.1)]"
              ...
              <div className="space-y-2 relative pt-6">
                ...
                ></textarea>
                {errors.objective && (
                  <span className="text-red-400 text-xs font-mono absolute -bottom-5 left-0">
