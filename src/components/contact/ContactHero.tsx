...
export function ContactHero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full min-h-[50vh] lg:min-h-[60vh] flex flex-col items-center justify-center bg-slate-950 overflow-hidden pt-32 pb-16"
    >
      ...
      <div className="container relative z-20 px-4 mx-auto text-center flex flex-col items-center">
        ...
        <h1 className="text-5xl sm:text-7xl md:text-[8rem] lg:text-[10rem] font-black text-white tracking-tighter flex overflow-hidden leading-[0.9] drop-shadow-2xl hero-text select-none">
          LET'S BUILD
          <br className="lg:hidden" /> EMPIRES.
        </h1>
        ...
        <p className="hero-text mt-4 max-w-3xl text-sm md:text-xl font-mono text-slate-400 leading-relaxed px-4">
          I would love to hear about your vision. Share your project details below, and if we're a great fit, I'll personally reach out to you within 24 hours to discuss how we can build something extraordinary together.
        </p>
      </div>
    </section>
  );
